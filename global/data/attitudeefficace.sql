...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 05 juin 2020 à 22:05
...
INSERT INTO `item_childs` (`id`, `code`, `categorie`, `parent_id`, `title`, `description`, `slug`, `article_content`, `author`, `provider`, `pages`, `price`, `rang`, `edition_home`, `annee_parution`, `date_creation`, `date_modification`, `date_post`, `youtube_video_link`, `views`) VALUES
...
INSERT INTO `item_parents` (`id`, `code`, `categorie`, `title`, `description`, `slug`, `price`, `rang`, `date_creation`, `date_modification`, `date_post`, `views`, `youtube_video_link`) VALUES
